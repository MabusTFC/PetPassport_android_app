...
abstract class ScreenModelModule {
    ...
    @Binds
    @IntoMap
    @ScreenModelKey(RecommendedProceduresScreenModel::class)
    abstract fun bindRecommendedProceduresScreenModel(model: RecommendedProceduresScreenModel): ScreenModel
